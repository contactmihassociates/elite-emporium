...
const HARDCODED_PRODUCTS = [
  // Home & Kitchen
  {
    ...
    desc: "<p class='pd-desc-para'>The 3-Piece Stainless Steel Grater &amp; Drain Bowl Set is a thoughtfully designed kitchen workhorse that quietly replaces four or five single-purpose tools with one elegant stacking system. Built from thickened food-grade SS304 stainless steel, it&rsquo;s engineered to handle direct heat, daily scrubbing, and decades of family cooking without warping, rusting or losing its mirror finish.</p><p class='pd-desc-para'>The set nests into a single shelf footprint: a deep mixing bowl for whisking batter or soaking dal, a perforated drain colander that doubles as a rice strainer, and a multi-blade grater lid that snaps on top to turn the whole assembly into a salad-prep station. Lift the lid off and you have three pieces; stack them up and you have one.</p><ul class='pd-desc-list'><li><strong>5 mm julienne blade</strong> &mdash; perfect for carrot, radish and beetroot strips for kosambari, pulao and salads.</li><li><strong>3 mm slicer blade</strong> &mdash; clean, even slices of cucumber, onion and potato for sandwiches and chips.</li><li><strong>Wavy slicer</strong> &mdash; restaurant-style crinkle cuts for kids&rsquo; tiffin and party platters.</li><li><strong>Direct-heat safe</strong> &mdash; the thick base can sit on a flame for warming leftovers or boiling water.</li><li><strong>Dishwasher friendly</strong>, scratch-resistant, zero plastic in the food path.</li></ul><p class='pd-desc-para'>Indian kitchens are tight on storage and big on prep. This set is the answer: rinses clean in seconds, outlasts plastic mandolins by years, and looks good enough to leave on the counter. Hand-wash for the best finish; dishwasher-safe on the top rack.</p><p class='pd-desc-para'><strong>What&rsquo;s in the box:</strong> 1 deep mixing bowl, 1 drain colander, 1 grater lid with three interchangeable blade inserts. Free delivery in India over &#8377;499.</p>",
  ...
  },
  {
    ...
    desc: "<p class='pd-desc-para'>The <strong>KBC Jumbo Grill</strong> is a serious 2000-watt electric contact griller built for Indian families that want restaurant-quality sandwiches, paninis and tandoor-style vegetables without firing up a gas tandoor or buying three separate appliances. With its oversized non-stick ribbed plates and floating-hinge design, it handles everything from a four-slice cheese sandwich to a stack of chicken tikka skewers in one go.</p><p class='pd-desc-para'>Compared to the small 750-watt &lsquo;college hostel&rsquo; grillers, this is a different animal: it pre-heats in under 90 seconds, sears clean grill marks, and seals juices in so chicken stays tender and paneer doesn&rsquo;t go rubbery. The wide-opening hinge means you can grill thick items like a stuffed paratha or a thick fish fillet without crushing them.</p><ul class='pd-desc-list'><li><strong>2000 W heating element</strong> &mdash; serious power, restaurant-grade sear in 3&ndash;4 minutes.</li><li><strong>Jumbo non-stick ribbed plates</strong> &mdash; fits four full sandwiches or a whole tray of vegetables at once.</li><li><strong>Floating hinge</strong> &mdash; accommodates items up to 5 cm thick (think stuffed paratha or chicken legs).</li><li><strong>Indicator lights</strong> for power and ready-to-grill status.</li><li><strong>Cool-touch handle</strong> with a secure lock for safe storage.</li><li><strong>2-year manufacturer warranty</strong> covering heating element and plates.</li></ul><p class='pd-desc-para'>Perfect for Sunday brunch panini stations, after-school tiffin sandwiches, weekend tandoor parties and Iftar evenings during Ramadan. Cleans up in 60 seconds &mdash; wipe the plates with a damp cloth while they&rsquo;re still warm, no soaking required.</p><p class='pd-desc-para'><strong>What&rsquo;s in the box:</strong> 1 KBC Jumbo Grill unit, 1 user manual, 1 warranty card, 230 V AC power cord with 3-pin Indian plug. Free delivery in India over &#8377;499.</p>",
  ...
  // Bags
  {
    ...
    desc: "<p class='pd-desc-para'>A grown-up makeup bag with a wink of charm: the <strong>Cute Animal Print 3-Grid Cosmetic Organiser</strong> wraps a serious 3-compartment beauty system inside a soft panda-face printed PU-leather shell. It&rsquo;s the bag that disappears into a tote during the week and travels to a wedding on the weekend without looking out of place.</p><p class='pd-desc-para'>The three internal grid compartments are deliberately sized to fit full-size beauty bottles, not just travel minis. The centre grid holds tall items upright (think foundation, micellar water, setting spray); the two side grids cradle smaller pieces (lipsticks, eyeliners, brushes) so nothing rolls around and nothing leaks into the rest of your handbag.</p><ul class='pd-desc-list'><li><strong>Premium PU leather</strong> exterior &mdash; wipe-clean if your foundation pump leaks.</li><li><strong>3 spacious grid compartments</strong> &mdash; structured, padded dividers (not floppy fabric).</li><li><strong>Zippered closure</strong> with a smooth metal pull &mdash; one-handed open and shut.</li><li><strong>Top carry handle</strong> &mdash; carry by hand, drop into a tote, or hang from a hotel bathroom hook.</li><li>Generous interior dimensions: comfortably holds a foundation bottle, eyeshadow palette, 4&ndash;5 brushes, sunscreen, primer and a few lipsticks at once.</li></ul><p class='pd-desc-para'>Especially great for makeup artists, brides assembling their getting-ready kit, students moving between hostel and home, and frequent travellers who hate spilled lipstick on white shirts. Wipes clean with a damp microfibre cloth; do not machine-wash.</p><p class='pd-desc-para'><strong>Heads-up:</strong> the panda print is hand-painted style on PU leather. Each piece has tiny natural variations &mdash; that&rsquo;s how you know yours is unique. Free delivery in India over &#8377;499.</p>",
  ...
  },
  {
    ...
    desc: "<p class='pd-desc-para'>The <strong>YSL Quilted Tote with Matching Pouch</strong> is the bag people notice across a room and ask about afterwards. Finished in soft cream quilted leather with the iconic oversized gold YSL hardware on the front, this is a designer-inspired tote built at <strong>12A premium tier quality</strong> &mdash; the highest grade we stock, with meticulous double-stitching, tightly aligned quilting, and a leather hand-feel that genuinely passes for the real thing.</p><p class='pd-desc-para'>The shape is the classic everyday tote silhouette: structured base that holds its form, dual rolled top handles that comfortably hand-carry or rest on a shoulder, and an internal compartment roomy enough for a 13-inch laptop, an iPad, an A5 planner, a water bottle and a wallet without bulging. The included matching quilted zip pouch is no afterthought &mdash; it&rsquo;s sized as a real cosmetic / mini-essentials clutch and stays neatly inside the tote on a snap leash.</p><ul class='pd-desc-list'><li><strong>12A premium quality</strong> &mdash; our top tier, with reinforced base, padded handles and fade-resistant gold-tone hardware.</li><li><strong>Cream quilted leather</strong> &mdash; soft to the touch, holds its shape, develops a beautiful patina over months.</li><li><strong>Oversized YSL logo</strong> in brushed gold &mdash; the front centrepiece.</li><li><strong>Matching zip pouch</strong> attached on a snap chain &mdash; doubles as an evening clutch.</li><li><strong>Magnetic top closure</strong> + interior zip pocket and two slip pockets.</li><li>Approximate dimensions: 32&times;28&times;14 cm. Weight: ~750 g (light for its size).</li></ul><p class='pd-desc-para'>Works as a workday tote, an airport carry, a wedding-shopping bag and a brunch statement piece. The cream colour reads as &ldquo;light, fresh, polished&rdquo; rather than &ldquo;loud&rdquo; &mdash; pairs beautifully with sarees, abayas, kurtas, jeans and dresses alike.</p><p class='pd-desc-para'><strong>Care:</strong> wipe with a soft dry cloth weekly; keep in the included dust bag when not in use; avoid direct sunlight for long periods to preserve the cream tone. <strong>Includes:</strong> tote, matching pouch, dust bag. Free delivery over &#8377;499.</p>",
  ...
  },
  {
    ...
    desc: "<p class='pd-desc-para'>The <strong>Coach Field Tote 30 in Color Block</strong> is the bag that proves understatement is the loudest statement of all. The silhouette is pure Coach &mdash; structured, balanced, instantly recognisable &mdash; rendered in a smart three-tone palette of <strong>white pebbled body, cognac brown top handles, and navy blue trim with subtle gold stud accents</strong>. Built at <strong>12A premium tier quality</strong>, our highest grade.</p><p class='pd-desc-para'>What makes the Field Tote 30 a perennial Coach favourite isn&rsquo;t a logo &mdash; it&rsquo;s the proportions. At 30 cm wide, it&rsquo;s the rare bag that&rsquo;s big enough to be a work tote and refined enough to walk into a dinner with. The body is hand-stitched pebbled leather (the texture Coach is known for), and the embossed <em>Coach Leatherware Est. 1941</em> front plate is debossed at the right depth so it reads as quietly luxurious rather than branded.</p><ul class='pd-desc-list'><li><strong>12A premium quality</strong> &mdash; reinforced structured base, edge-painted seams, fade-resistant hardware.</li><li><strong>Color-block construction</strong> &mdash; white pebbled leather body, cognac brown handles, navy trim, gold stud accents.</li><li><strong>Embossed Coach Leatherware</strong> heritage branding on the front panel.</li><li><strong>Wide open-top design</strong> with snap closure &mdash; easy access for a laptop and daily essentials.</li><li><strong>Two internal slip pockets</strong> + one zipped pocket for valuables.</li><li>Approximate dimensions: 30&times;26&times;13 cm. Comes with a Coach-branded dust bag.</li></ul><p class='pd-desc-para'>Perfect as a workday companion, a weekend brunch carry, a travel personal-item, or a gift for someone who already has &lsquo;a black bag&rsquo; and needs something with personality. The colour-block tones pair effortlessly with denim, white shirts, ethnic kurtas and sarees.</p><p class='pd-desc-para'><strong>Care:</strong> wipe with a soft cloth, condition pebbled leather every 3&ndash;4 months, store in dust bag. <strong>Includes:</strong> Coach Field Tote, branded dust bag. Free delivery over &#8377;499.</p>",
  ...
  // Wallets / Men's Combos
  {
    ...
    desc: "<p class='pd-desc-para'>The <strong>Coach New York 3-Piece Men&rsquo;s Gift Set</strong> is the easiest &lsquo;great gift&rsquo; in our entire catalogue &mdash; the kind of present that gets nods at every birthday, anniversary, Eid, Diwali, wedding gift exchange and corporate farewell we&rsquo;ve packed it for. Three coordinated leather accessories, all in premium black leather with Coach&rsquo;s signature embossed-C monogram, presented in a Coach-branded gift box that needs no extra wrapping.</p><p class='pd-desc-para'>This isn&rsquo;t a &lsquo;novelty gift set&rsquo; &mdash; each piece is a genuinely useful daily-carry item with proper edge stitching, real leather feel and durable hardware. The wallet alone holds its own against any standalone wallet in the same price range; bundled with the card holder and belt, it&rsquo;s an unbeatable value.</p><ul class='pd-desc-list'><li><strong>Bifold Wallet</strong> &mdash; 6 card slots, 2 cash compartments, 1 ID window. Coach embossed-C pattern across the front. Slim profile that won&rsquo;t bulge in a back pocket.</li><li><strong>Slim Card Holder</strong> &mdash; 4 quick-access slots, perfect for daily-carry essentials without the full wallet bulk. Great for office IDs and metro cards.</li><li><strong>Reversible Leather Belt</strong> &mdash; black one side, brown the other, with a silver Coach-engraved buckle. Twist the buckle to flip the strap; one belt covers two outfits. Comes ~110 cm long, can be trimmed to fit.</li><li><strong>Coach-branded gift box</strong> &mdash; ribbon-tied, gift-ready, no wrapping needed.</li></ul><p class='pd-desc-para'>The ideal gift for: birthdays, anniversaries, Father&rsquo;s Day, Eid/Diwali, work farewells, brother-in-law&rsquo;s wedding, and &lsquo;I forgot to buy something for him&rsquo; emergencies. We&rsquo;ve had repeat customers buy this set 4 or 5 times over the year for different gift occasions.</p><p class='pd-desc-para'><strong>Care:</strong> wipe with dry cloth; condition leather every 3&ndash;4 months. <strong>Free engraving available</strong> &mdash; WhatsApp us within 1 hour of ordering if you&rsquo;d like initials added (free over &#8377;1,500). Free delivery over &#8377;499.</p>",
  ...
  },
  {
    ...
    desc: "<p class='pd-desc-para'>The <strong>Armani Exchange (A|X) 4-Piece Men&rsquo;s Gift Set</strong> takes the gift-set formula and adds a fourth piece &mdash; a separate A|X-engraved buckle &mdash; making it a complete &lsquo;outfit accessories&rsquo; bundle in one branded box. Crafted in deep dark leather with the bold <strong>A|X</strong> monogram subtly debossed across each piece, it&rsquo;s aimed at the man who wears Armani Exchange on his t-shirt and wants the rest of his look to keep up.</p><p class='pd-desc-para'>A|X (Armani Exchange) is the younger, sharper sub-brand of Armani &mdash; less stuffy, more streetwear-influenced, more confident with branding. This gift set captures that energy: clean lines, dark leather, restrained logos, modern hardware. Looks fantastic against jeans, formal trousers, and the linen pants men actually want to wear in Tamil Nadu summers.</p><ul class='pd-desc-list'><li><strong>Bifold A|X Wallet</strong> &mdash; 6 card slots, 2 cash compartments, 1 ID window. Subtle A|X emboss on the front. Built to slim down a back pocket without losing capacity.</li><li><strong>Slim Card Holder</strong> &mdash; 4 quick-access slots for daily-carry. Pairs with the wallet but works solo for gym/office trips.</li><li><strong>Reversible A|X Leather Belt</strong> &mdash; dark brown / black two-tone, twist-to-flip buckle. One belt, two outfits.</li><li><strong>Standalone A|X buckle</strong> &mdash; engraved Armani Exchange logo, fits standard 35 mm leather straps for swap-and-match versatility.</li><li><strong>Branded A|X gift box</strong> with foam tray and ribbon &mdash; gift-ready.</li></ul><p class='pd-desc-para'>Right occasion for: birthdays, engagement gift to a brother-in-law, Father&rsquo;s Day, work farewells, corporate gifting (we&rsquo;ll batch-pack 5+ sets on request). Reads as &lsquo;designer&rsquo; without being loud about it &mdash; perfect for the man who wears Armani t-shirts but draws the line at logos shouting at him from his wallet.</p><p class='pd-desc-para'><strong>Care:</strong> wipe leather with a soft cloth, avoid soaking, condition every 3&ndash;4 months. <strong>Belt size:</strong> trims to fit, comes ~110 cm. Free delivery over &#8377;499.</p>",
  ...
  // Watches
  {
    ...
    desc: "<p class='pd-desc-para'>The <strong>Tommy Hilfiger Men&rsquo;s Black Chronograph</strong> is a serious all-black tool watch with the kind of presence you only notice once you start getting compliments on it. The full matte-black finish &mdash; case, bezel, dial, and steel link bracelet &mdash; reads as understated and confident, while the three working sub-dials and HILFIGER-engraved bezel keep it from being just another black watch.</p><p class='pd-desc-para'>The chronograph is genuinely useful, not just decorative: a working stopwatch with 30-minute and 24-hour totalisers plus a continuous-running seconds dial. Whether you&rsquo;re timing your morning run, a kitchen recipe, or a kid&rsquo;s exam revision, the layout is clean and the pushers click crisp.</p><ul class='pd-desc-list'><li><strong>All-black matte finish</strong> &mdash; case, bezel, dial, and steel link bracelet, all in coordinated matte black.</li><li><strong>HILFIGER-engraved black bezel</strong> &mdash; subtle 3D-engraved branding around the rim.</li><li><strong>Three functional sub-dials</strong> &mdash; 30-minute counter, 24-hour counter, continuous seconds.</li><li><strong>Silver-tone hour and minute hands</strong> &mdash; high contrast against the textured black dial for easy reading.</li><li><strong>Stainless steel link bracelet</strong> with butterfly clasp &mdash; extra links can be removed locally.</li><li><strong>Case size:</strong> ~44 mm. <strong>Water resistance:</strong> 3 ATM (splash &amp; rain, not for swimming).</li></ul><p class='pd-desc-para'>Works for office, weddings, weekend trips, gym sessions and grocery runs alike. Pairs cleanly with formal shirts, polo tees and ethnic kurtas. A particularly good gift for someone shifting into their first corporate role &mdash; quietly says &lsquo;I&rsquo;m serious about what I do&rsquo;.</p><p class='pd-desc-para'><strong>Includes:</strong> Tommy Hilfiger watch, original brand pillow pouch, care instructions card. GST invoice on request. Free delivery over &#8377;499.</p>",
  ...
  },
  {
    ...
    desc: "<p class='pd-desc-para'>The <strong>Tommy Hilfiger Chronograph &mdash; Gift Box Edition</strong> takes our most popular all-black Hilfiger chronograph and packages it inside a premium navy-blue Tommy Hilfiger presentation box, transforming a watch order into a fully gift-ready piece &mdash; no extra wrapping, no last-minute scrambling, no awkward presentation.</p><p class='pd-desc-para'>This is the watch we ship the most of during wedding season, Diwali, Eid, Father&rsquo;s Day and corporate-gifting weeks. The recipient lifts the lid, sees a watch in its signed pillow, on Tommy Hilfiger branded foam, with care card and authenticity insert. It looks exactly like the in-store gifting experience.</p><ul class='pd-desc-list'><li><strong>Premium navy gift box</strong> &mdash; magnetic-flap lid, Tommy Hilfiger crest debossed on top, branded foam tray inside.</li><li><strong>All-black matte chronograph</strong> &mdash; HILFIGER-engraved bezel, textured black dial, three working sub-dials (30-min, 24-hr, continuous seconds).</li><li><strong>Black stainless steel link bracelet</strong> with butterfly clasp.</li><li><strong>Silver-tone hands</strong> for clear contrast against the black dial.</li><li><strong>Case size:</strong> ~44 mm. <strong>Water resistance:</strong> 3 ATM (splash &amp; rain safe).</li><li><strong>Includes:</strong> watch, gift box, pillow pouch, branded care card.</li></ul><p class='pd-desc-para'>Ideal as a wedding gift, Father&rsquo;s Day surprise, engagement memento, retirement send-off, or year-end employee recognition. Send it directly to the recipient&rsquo;s address &mdash; WhatsApp us a gift note and we&rsquo;ll add it to the parcel (free).</p><p class='pd-desc-para'><strong>Order tip:</strong> mention &lsquo;gift order&rsquo; on WhatsApp and we&rsquo;ll skip price tags from the parcel and ship with a discreet outer wrap. Free delivery over &#8377;499.</p>",
  ...
  },
  {
    ...
    desc: "<p class='pd-desc-para'>The <strong>Tommy Hilfiger Men&rsquo;s Skeleton Automatic Watch</strong> is for the collector who wants to <em>see</em> what a watch actually does. Through a precisely cut open-heart aperture on the dial, you can watch the balance wheel oscillate, the escapement tick, and the rotor wind through the back &mdash; the mechanical heart of the watch, on display, every second of the day.</p><p class='pd-desc-para'>This isn&rsquo;t a quartz watch with a fake skeleton sticker &mdash; it&rsquo;s a genuine self-winding <strong>automatic movement</strong>. Wear it daily and you&rsquo;ll never need to change a battery or wind it manually; the motion of your wrist keeps it powered. Set it once and it runs.</p><ul class='pd-desc-list'><li><strong>Self-winding automatic movement</strong> &mdash; no battery, powered by wrist motion (40+ hours power reserve when fully wound).</li><li><strong>Open-heart skeleton aperture</strong> &mdash; the balance wheel and escapement are exposed at 6 o&rsquo;clock.</li><li><strong>Navy-blue concentric-circle dial</strong> with sunray finishing &mdash; catches the light beautifully under different angles.</li><li><strong>Polished silver stainless steel case &amp; bracelet</strong> &mdash; classic dress-watch look.</li><li><strong>Day &amp; date complication</strong> at 3 o&rsquo;clock.</li><li><strong>Case size:</strong> ~44 mm. <strong>Water resistance:</strong> 3 ATM.</li><li><strong>Glass:</strong> mineral crystal with anti-reflective coating.</li></ul><p class='pd-desc-para'>The kind of watch that gets noticed by other watch people. Strong choice for a 30th-birthday gift, an engagement gift, a graduation gift to a son or nephew, or an &lsquo;upgrade your everyday watch&rsquo; moment for yourself. Pairs effortlessly with formal shirts and ethnic Sherwani.</p><p class='pd-desc-para'><strong>Care:</strong> wear it 2&ndash;3 times a week to keep the movement healthy. If left idle for &gt;48 hours, rotate the crown ~20 times to wind manually. Service every 3&ndash;4 years at any reputed watch service centre. <strong>Includes:</strong> watch, pillow pouch, care insert. Free delivery over &#8377;499.</p>",
  ...
  // Sunglasses
  {
    ...
    desc: "<p class='pd-desc-para'>The <strong>Marc Jacobs Navigator Sunglasses &mdash; Model 486</strong> are the rare pair that&rsquo;s genuinely flattering on almost every face shape: oval, round, square, heart, and the much-debated &lsquo;long&rsquo; face. The navigator silhouette is a sharper, more architectural cousin of the classic aviator &mdash; angular at the top, gently rounded at the bottom &mdash; and Marc Jacobs nails the geometry on Model 486.</p><p class='pd-desc-para'>The frame is a beautiful <strong>transparent amber acetate</strong> &mdash; not flat plastic but the rich layered acetate Italian frame-makers use, with a depth that catches the light. Lenses are <strong>gradient honey-brown</strong>: darker at the top to cut overhead glare, lighter at the bottom so your face stays expressive. Temples are matte black with the MARC JACOBS branding in subtle white.</p><ul class='pd-desc-list'><li><strong>Frame:</strong> transparent amber acetate, navigator silhouette, ~144 mm temple length.</li><li><strong>Lenses:</strong> gradient honey-brown, polycarbonate, UV400 protection (blocks 100% of UVA &amp; UVB).</li><li><strong>Temples:</strong> matte black with MARC JACOBS white branding on the outside arm.</li><li><strong>Adjustable silicone nose pads</strong> &mdash; stays put even on smaller Indian nose bridges.</li><li><strong>Comes with</strong> a Marc Jacobs oval white case (eg. travel-friendly hard case) and a Marc Jacobs microfibre cleaning cloth.</li><li><strong>Full kit option</strong> available with branded box at &#8377;1,300 &mdash; WhatsApp us if you&rsquo;d like to upgrade.</li></ul><p class='pd-desc-para'>Excellent for everyday driving, weddings, photoshoots, long-haul flights, and beach holidays. The amber/honey palette is warm and approachable &mdash; reads sophisticated, not aggressive. Pairs especially well with cream, olive, navy and beige outfits.</p><p class='pd-desc-para'><strong>Care:</strong> always store in the case when not worn; clean with the included microfibre cloth (water + dish soap is fine for stuck-on grime; avoid alcohol-based cleaners on the acetate). Free delivery over &#8377;499.</p>",
  ...
  },
  {
    ...
    desc: "<p class='pd-desc-para'>The <strong>Celine Paris Oval Metal Sunglasses</strong> are the &lsquo;Parisian Sunday&rsquo; pair &mdash; quiet, elegant, almost rimless, with that confident French restraint that&rsquo;s impossible to fake. Slim gold metal frames, oval dark-grey lenses, and the unmistakable Celine interlocking-C logo on the bridge: nothing more, nothing less.</p><p class='pd-desc-para'>The oval shape is having a major fashion moment again, and Celine&rsquo;s version is the reference everyone else is copying. The metal is light enough that you forget you&rsquo;re wearing them; the dark grey lenses are deep enough for harsh Tamil Nadu sun but neutral enough that colours look natural through them &mdash; unlike rose or amber tints, which can shift everything you see.</p><ul class='pd-desc-list'><li><strong>Frame:</strong> slim gold-tone metal, near-rimless construction, lightweight (~22 g).</li><li><strong>Lenses:</strong> oval dark grey, polycarbonate, UV400 protection (blocks 100% UVA &amp; UVB).</li><li><strong>Bridge:</strong> interlocking-C Celine logo in matching gold tone &mdash; the signature detail.</li><li><strong>Adjustable silicone nose pads</strong> for comfort on long wear.</li><li><strong>Temple length:</strong> ~140 mm &mdash; fits most medium and slim faces beautifully.</li><li><strong>Comes with</strong> a Celine-branded black hard case + Celine microfibre cleaning cloth.</li><li><strong>Full kit option</strong> with branded pouch and box at &#8377;1,300 &mdash; ask on WhatsApp.</li></ul><p class='pd-desc-para'>Right for: cafe brunches, evening walks, airports, weddings as the &lsquo;photo accessory&rsquo;, and being the most quietly stylish person in any group photo. Pairs effortlessly with sarees, kurtas, summer dresses, and a crisp white shirt.</p><p class='pd-desc-para'><strong>Care:</strong> store in the case when not in use; clean with the included microfibre cloth; avoid leaving on a hot dashboard (the metal expands and frames can warp). Free delivery over &#8377;499.</p>",
  ...
  // Women's Ethnic Wear
  {
    ...
    desc: "<p class='pd-desc-para'>The <strong>Heavy Embroidery Anarkali Lehenga Gown Set</strong> is the centrepiece outfit our customers come back for again and again &mdash; the kind of piece that turns a wedding guest into a wedding moment. A full floor-length anarkali with dense gold zari embroidery cascading from neckline to hem, an enormous twirl-worthy flare, and a colour range deep enough to suit every skin tone and every occasion.</p><p class='pd-desc-para'>The embroidery isn&rsquo;t printed or screen-applied &mdash; it&rsquo;s real <strong>zari thread work with sequin and bead accents</strong>, hand-finished along the dupatta border and clustered into intricate floral motifs across the bodice and skirt. The fabric drapes beautifully even when standing still, and it moves like silk on a dance floor.</p><ul class='pd-desc-list'><li><strong>Available in 9 rich colours</strong> &mdash; Navy Blue, Teal, Red, Golden Yellow, Dark Purple, Maroon, Burgundy, Cream-Gold, and Black. Tell us your preferred shade on WhatsApp.</li><li><strong>Full-length anarkali silhouette</strong> &mdash; fitted bodice, A-line flare reaching the ankles, designed to flatter every body type.</li><li><strong>Dense gold zari embroidery</strong> with sequin highlights across the bodice, skirt and dupatta border.</li><li><strong>Matching dupatta included</strong> &mdash; same colour family with embroidered edge.</li><li><strong>Inner lining</strong> in the same colour for opacity and comfort.</li><li><strong>Sizes:</strong> available in S / M / L / XL / XXL. Free size adjustments are not possible &mdash; please share your measurements at checkout.</li></ul><p class='pd-desc-para'>Perfect for: weddings (your own or as a guest), engagement ceremonies, mehendi/sangeet evenings, reception parties, Eid celebrations, Diwali pujas, and family gatherings where you want to be remembered. Pair with statement gold jhumkas, a wide kamarband and a pair of embroidered juttis or block heels.</p><p class='pd-desc-para'><strong>Care:</strong> dry-clean only. Store wrapped in muslin cloth, separated from other heavy embroidery to prevent threads catching. Spot-test before any moisture &mdash; the dye is rich but not unconditionally fade-resistant.</p><p class='pd-desc-para'><strong>Order tip:</strong> WhatsApp us your bust / waist / hip / shoulder-to-floor measurements at checkout. We&rsquo;ll confirm the best size from stock or guide you to the closest fit. Free delivery over &#8377;499.</p>",
  ...
  },
  {
    ...
    desc: "<p class='pd-desc-para'>The <strong>Blush Pink Anarkali Gown with Embroidered Dupatta</strong> is what we&rsquo;d wear to a daytime sangeet, an Eid lunch, or a baby shower &mdash; not too heavy, not too plain, with the kind of soft luminous pink that photographs beautifully under both natural light and indoor LEDs. It&rsquo;s the &lsquo;feminine but not fussy&rsquo; outfit our customers ask for again and again.</p><p class='pd-desc-para'>Crafted from <strong>soft tissue-blend fabric</strong> &mdash; the lightweight, slightly sheeny variety that drapes like silk but breathes like cotton &mdash; the gown features a delicately embroidered neckline with subtle <strong>mirror work and pearl accents</strong>, a wide twirl-worthy flare from the empire waist, and a charming scalloped hem that catches the eye when you move.</p><ul class='pd-desc-list'><li><strong>Colour:</strong> dusty blush pink (the photogenic, universally-flattering shade &mdash; not bright bubblegum).</li><li><strong>Fabric:</strong> soft tissue-blend, light and flowy with subtle sheen.</li><li><strong>Silhouette:</strong> empire-waist anarkali, floor-length, wide A-line flare with scalloped hem.</li><li><strong>Neckline detail:</strong> embroidered with mirror work and pearl beading along the V-cut.</li><li><strong>Sleeves:</strong> three-quarter, gathered at the cuff.</li><li><strong>Matching dupatta:</strong> blush pink with an embroidered scalloped border in cream and silver threadwork.</li><li><strong>Inner lining</strong> in the same colour family for opacity.</li><li><strong>Sizes:</strong> S / M / L / XL / XXL &mdash; share your measurements at checkout for the closest fit.</li></ul><p class='pd-desc-para'>Excellent for: Eid celebrations, daytime sangeet functions, engagement ceremonies, family weddings as a guest (not the bride), birthday parties, and casual festive gatherings where you want to look elevated but not overdressed. Pair with rose-gold jhumkas, a pearl necklace, and nude or rose-gold block heels.</p><p class='pd-desc-para'><strong>Care:</strong> dry-clean preferred; gentle hand-wash in cold water works for occasional refresh. Air-dry in shade &mdash; direct sun will fade the soft pink over time. Store on a padded hanger to preserve the scalloped hem.</p><p class='pd-desc-para'><strong>Order tip:</strong> WhatsApp bust / waist / hip / shoulder-to-floor measurements at checkout. We&rsquo;ll confirm the best fit. Free delivery over &#8377;499.</p>",
  ...
  // Men's Dress
  {
    ...
    desc: "<p class='pd-desc-para'>The <strong>Calvin Klein (CK) Men&rsquo;s Casual Shirts</strong> are the wardrobe workhorse you&rsquo;ll wear three days a week without realising it. A clean relaxed-fit cotton-blend shirt with a single chest pocket, subtle CK logo patch on the pocket, and a colour range deep enough to build an entire monsoon-to-winter rotation from one product page.</p><p class='pd-desc-para'>The fabric is a <strong>medium-weight cotton blend</strong> &mdash; soft enough to wear straight off the iron, structured enough to look sharp tucked in, and forgiving enough to throw in the washing machine after a long day. Buttons are reinforced, seams are double-stitched, collars hold their shape after dozens of washes. This isn&rsquo;t a one-season shirt &mdash; it&rsquo;s a two-year shirt.</p><ul class='pd-desc-list'><li><strong>12+ colours available</strong> &mdash; Brown, Khaki, Olive Green, Grey, Beige, White, Dark Green, Black, Mustard, Wine Red, Navy Blue, Light Blue. Order any colour on WhatsApp.</li><li><strong>Fit:</strong> relaxed-casual &mdash; not skin-tight, not boxy. Sits well on most builds.</li><li><strong>Fabric:</strong> medium-weight cotton-blend, breathable, low-shrinkage.</li><li><strong>Details:</strong> single chest pocket with CK logo patch, full button placket, soft collar that holds shape, finished cuffs.</li><li><strong>Sleeves:</strong> half-sleeves (request full-sleeve variants on WhatsApp if available in your size).</li><li><strong>Sizes:</strong> S / M / L / XL / XXL &mdash; standard Indian sizing.</li></ul><p class='pd-desc-para'>Wears equally well over a plain tee for college, with chinos for office Fridays, with jeans for a date, or with a lungi/dhoti for casual evenings at home. The CK logo is subtle enough to not feel showy &mdash; it whispers brand, doesn&rsquo;t shout.</p><p class='pd-desc-para'><strong>Care:</strong> machine-wash cold with similar colours, tumble-dry low or air-dry, iron on medium heat. Colours hold up well through 50+ washes with normal care.</p><p class='pd-desc-para'><strong>Order tip:</strong> not sure of size? Share your chest measurement (in inches) and a current well-fitting shirt&rsquo;s size on WhatsApp &mdash; we&rsquo;ll recommend the right fit. <strong>Bulk pricing</strong> available for 5+ shirts &mdash; ask us. Free delivery over &#8377;499.</p>",
